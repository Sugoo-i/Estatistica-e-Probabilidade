...
ValorP.addEventListener("keypress", (event) => {
  if (event.key === "Enter") {
    let P = document.getElementById("valorP").value;
    let gg = document.getElementById("valorP");
    console.log(P);
    gg.readOnly = true;
  }
});
...
calcular.addEventListener("click", (event) => {
  ...
  if (ativado == 1) {
    resultado.innerHTML = PermutacaoSimples();
  } else if (ativado == 2) {
    resultado.innerHTML = ArranjosSimples();
  } else if (ativado == 3) {
    resultado.innerHTML = CombinacoesSimples();
  } else if (ativado == 4) {
    resultado.innerHTML = PermutacaoRepeticao();
  } else if (ativado == 5) {
    resultado.innerHTML = ArranjosRepeticao();
  } else if (ativado == 6) {
    resultado.innerHTML = CombinacoesRepeticao();
  }
});
